			  ...
			  GsApp			    *app)
{
	...
	GtkWidget *installed_row = FALSE;
	gboolean can_installed;
	...
	can_installed = app_version != NULL && version_history->len > 1 && gs_app_is_installed (app);
	have_installed = !can_installed;
